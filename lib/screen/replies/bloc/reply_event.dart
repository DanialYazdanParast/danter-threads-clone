...
//----------------------------------
class DeletRplyEvent extends ReplyEvent {
  final String postid;

  const DeletRplyEvent({required this.postid});
}

class DeletRplyPostEvent extends ReplyEvent {
  final String postid;

  const DeletRplyPostEvent({required this.postid});
}
